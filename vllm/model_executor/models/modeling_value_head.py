...
class AutoModelForCausalLMWithValueHead(nn.Module):
    ...
    def load_weights(self,
        ...
        vhead_params = torch.load(osp.join(model_name_or_path, V_HEAD_WEIGHTS_NAME))
    ...
    def forward(
        ...
        hidden_states = self.pretrained_model.model(input_ids, positions, kv_caches, attn_metadata)  # cache_events
